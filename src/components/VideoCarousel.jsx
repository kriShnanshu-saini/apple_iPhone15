...
const VideoCarousel = () => {
	...
	useEffect(() => {
		...
		if (span[videoId]) {
			// TODO: animate the progress of video
					...
					<div key={list.id} id='slider' className='sm:pr-20 pr-10'>
						<div className='video-carousel_container'>
							<div className='w-full h-full flex-center rounded-3xl overflow-hidden bg-black '>
								<video id='video' playsInline={true} muted preload='auto' ref={el => (videoRef.current[i] = el)} onPlay={() => setVideo(prevVideo => ({ ...prevVideo, isPlaying: true }))} onLoadedMetadata={e => handleLoadedMetaData(i, e)}>
